...
type
  ...
  TTreeEditLink = class;
  /// <remarks>
  ///  класс обертка дл€ TreeEditLink.Edit: TWinControl
  /// </remarks>
  ...
  /// <remarks>
  /// провер€ет новые данные AData.Value: TColumnData после редактировани€ FEditor: TDataEditor;
  ///  заполн€ет TColumnData
  ///    IsValid: Boolean;
